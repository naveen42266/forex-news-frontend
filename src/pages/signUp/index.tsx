                        ...
                        <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg border-2 border-primary">
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                {inProgress ?
                                    <button
                                        disabled
                                        className="w-full px-4 py-2 font-semibold text-white bg-primary hover:bg-tertiary focus:outline-none focus:ring-2 focus:ring-primary"
                                    >
                                        <PropagateLoader className="pb-3" color="white" />
                                    </button> :
                                    <button
                                        type="submit"
                                        className="w-full px-4 py-2 font-semibold text-white bg-primary rounded-md hover:bg-tertiary focus:outline-none focus:ring-2 focus:ring-primary"
                                    >
                                        Sign Up
                                    </button>
                                }
                            ...
                            {formData.type === 'User' ?
                                <div className="flex flex-row justify-center ">
                                    <div></div>
                                    <span className="flex flex-row gap-1 px-4 py-2 bg-primary text-white rounded-md hover:bg-tertiary focus:outline-none focus:ring-2 focus:ring-primary" onClick={() => googleLogin()}>SignUp with <div className="font-semibold">Google</div></span>
                                    <div></div>
                                </div>
                                : ""}
                        </div>
